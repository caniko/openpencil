...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "dialog.openErrorLead" => "OpenPencil ไม่สามารถแยกวิเคราะห์ไฟล์ได้",
        ...
        "dialog.loadErrorOldVersion" => "ไฟล์นี้บันทึกด้วย OpenPencil เวอร์ชันเก่า ต้องบันทึกใหม่ก่อนจึงจะเปิดได้",
        ...
        "dialog.dropToOpen" => "วางเพื่อเปิด  ·  .op / .pen / .fig",
