...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Sign in to OpenPencil",
        ...
        "dialog.openErrorLead" => "OpenPencil could not parse the file.",
        ...
        "dialog.updateBody" => "OpenPencil {{version}} is available (you have {{current}}).\n\nOpen the releases page to download it?",
        "a11y.figmaImport" => "Import from Figma",
        "a11y.import" => "Import",
        "import.fromFigma" => "Import from Figma",
        "import.fromHtml" => "Import from HTML",
        "html.title" => "Import from HTML",
        "html.dropFile" => "Drop an .html file here",
        "html.orBrowse" => "or click to browse",
        "html.saveTip" => "Save the page from your browser (Cmd+S) as a complete page",
